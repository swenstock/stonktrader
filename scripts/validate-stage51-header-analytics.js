...
must(pre.includes('/v45-desktop-stage51-v55.css?v=63')&&/\/v45-desktop-stage51-v55\.js\?v=(55|57|60|62)/.test(pre),'Stage 51 assets are bootstrapped');
...
must(css.includes('.stage51-modal-content-v55 .stage53-standard-expand-toggle-v57{display:none!important}'),'redundant modal expand collapse control is hidden');
