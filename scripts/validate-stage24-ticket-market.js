...
must(ui.includes("$$('.inv-left span',row).forEach(x=>x.remove())")||css.includes('font-size:0!important'),'My Tickets removes descriptive subtext and keeps icon/name/quantity');
