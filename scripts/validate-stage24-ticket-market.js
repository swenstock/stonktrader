...
must(server.includes('/v45-ticket-market-v36.js?v=39')&&server.includes('/v45-my-tickets-cleanup-v37.js?v=39')&&server.includes('/v45-main-event-retirement-v1.js?v=3')&&server.includes('/v45-badge-market-stage4.js?v=2'),'repaired exchange, badge, and retirement assets are cache-busted and served');
