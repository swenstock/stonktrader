...
must(ui.includes("$$('.inv-left span',row).forEach(x=>x.remove())"),'My Tickets removes descriptive subtext and keeps icon/name/quantity');
...
must(server.includes('v45-ticket-market-v36.js?v=36')&&server.includes('v45-ticket-market-v35.css?v=36'),'v36 exchange assets are cache-busted and served');
