...
must(server.includes('/v45-ticket-market-v36.js?v=39')&&server.includes('/v45-my-tickets-cleanup-v37.js?v=38')&&server.includes('/v45-main-event-retirement-v1.js?v=3'),'repaired exchange and retirement assets are cache-busted and served');
