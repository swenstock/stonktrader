...
must(badgeSync.includes("fetch('/api/account/junior-broker'")&&badgeSync.includes("cache:'no-store'")&&badgeSync.includes('YOU OWN ${count}')&&badgeSync.includes('__SBC_EXCHANGE_MY_ACTIVITY_V1?.refresh'),'Badge ownership tally and Activity reconcile from authoritative Junior holdings');
