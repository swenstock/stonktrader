...
must(stageC.includes('/v45-test-stonk-faucet-v1.js?v=2')&&stageC.includes('/v45-exchange-own-orders-v1.js?v=5'),'final direct UI owner bootstraps TEST STONK and latest stable own-order manager');
