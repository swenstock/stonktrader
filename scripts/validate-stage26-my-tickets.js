...
must(ui.includes('/v45-ticket-native-hooks-v41.js?v=48'),'Jr Broker and QA ticket hook is cache-busted by My Tickets loader');
must(server.includes('v45-my-tickets-cleanup-v37.js?v=40'),'cache-busted My Tickets cleanup is served');
must(server.includes('myTicketsCleanup: "v40-auth-truthful-selector"'),'health reports auth-truthful My Tickets inventory cleanup');
