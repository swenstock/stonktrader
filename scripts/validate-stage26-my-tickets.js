...
must(stageC.includes('/v45-exchange-dialog-v1.js?v=5')&&stageC.includes('/v45-test-stonk-faucet-v1.js?v=3')&&stageC.includes('/v45-exchange-own-orders-v1.js?v=8'),'final direct UI owner boots cache-busted Exchange dialogs before QA and own-order helpers');
...
must(dialog.includes('/v45-exchange-routing-fill-v1.js?v=4')&&dialog.includes('/v45-exchange-tier-integrity-v1.js?v=3'),'dialog bootstrap loads cache-busted routing/fill and tier-integrity guards');
