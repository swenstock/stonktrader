...
const RISE_ART_SRC='/rise-of-turtles-approved-final.png.png';
const JR_VISIBLE='JR. BROKER';
const RACE_ENDPOINT='/api/leaderboard-v45/broker-race?limit=50';
const RISE_ART_ALT='RISE OF THE TURTLES. Collect Jr. Stonk Broker Badges. Climb higher. Get promoted. NEXT IN LINE FOR PROMOTION';
...
window.__SBC_LOBBY_INSTALL_V1_TEST={installLobbyHero,normalizeJrBrokerLabels,renderRace,raceRows,progressDisplay,progressClass,HERO_SRC,RISE_ART_SRC,JR_VISIBLE,RACE_ENDPOINT};
})();
