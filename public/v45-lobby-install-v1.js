...
const HERO_SRC='/approved-lobby-hero-widget-free.png';
...
function install(){installLobbyHero();retireLobbyStatementStrip();normalizeJrBrokerLabels();patchJrStonkBrokerBadgeArt();}
...
window.__SBC_LOBBY_INSTALL_V1_TEST={installLobbyHero,normalizeJrBrokerLabels,retireLegacyRiseWidget,retireLobbyStatementStrip,patchJrStonkBrokerBadgeArt,HERO_SRC,JR_VISIBLE,JR_STONK_BROKER_BADGE_ART};
})();
