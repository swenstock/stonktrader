...
function ensureSettlement(){
  if(!window.__sbcTicketNativeHooksV41&&!document.querySelector('script[data-sbc-ticket-native-v41]')){const s=document.createElement('script');s.src='/v45-ticket-native-hooks-v41.js?v=46';s.dataset.sbcTicketNativeV41='1';document.head.appendChild(s);}
