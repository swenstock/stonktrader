...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket v19 two-column/Degen + market queue v14 + advanced orders v15-safe + trade UI polish v16 + header/stocks v16; tutorials hard-paused`);
});
