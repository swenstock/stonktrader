...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket v19 + compact stop family + DOM-safe chart polish v28 + native Trade This Entry + native My Contests positioning v27; tutorials hard-paused`);
});
