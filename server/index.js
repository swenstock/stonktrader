...
app.get("/api/health", (req, res) => res.json({
  ...
  desktopWorkspace: "v47-positions-orders-chart-oe",
...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Stage 45 stabilized/wide chart v50 + desktop Stage 44 chart scale/zoom/pan v49 + desktop Stage 43 chart/order UI v48 + desktop Stage 42 workspace v47 + named basket library + sticky review controls + inline Game Film analyzer + desktop trading refinement v46 + Sell All + basket cash sizing/rebalance + native working orders + idempotent portfolio header v44 + server-first 59-symbol basket universe v47 + My Tickets raw-text cleanup v37 + ticket exchange controls v36 + popup-only leaderboard v34 + native tier card sizing + contest-first leaderboard order v31 + DOM-safe chart polish v28 + normalized view landings v29; tutorials hard-paused`);
});
