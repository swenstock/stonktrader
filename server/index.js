...
app.get("/api/health", (req, res) => res.json({
  ...
  tradeCleanup: "v10",
  createABasket: "v18-select-adjust",
  marketQueue: "v14",
...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket v18 select/adjust + market queue v14 + advanced orders v15-safe + trade UI polish v16 + header/stocks v16; tutorials hard-paused`);
});
