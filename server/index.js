...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket v19 + compact stop family + chart-header symbol selector v20 + entry actions v20 + entry trade reset v22; tutorials hard-paused`);
});
