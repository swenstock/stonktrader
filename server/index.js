...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket stage2-queue + market queue v14 + advanced orders v15-safe + trade UI polish v16; tutorials hard-paused`);
});
