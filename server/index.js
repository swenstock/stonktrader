...
app.get("/api/health", (req, res) => res.json({
  ...
  myContestEntrySync: "retired-backend-authority-v1",
  backendAuthority: "v1-real-ownership-and-entry",
  tradeCleanup: "v10",
  ...
  stageCUiCleanup: "v1-activity-refresh-readable-confirm",
  ...
  tradeReceipt: "v6-frozen-workspace-guard",
  ...
  chartInteractions: "v59-mature-lightweight-charts",
  ...
  lobbyInstall: "v1-approved-hero-jr-broker",
  ticketExchangeControls: "v36-real-ticket-authority",
  badgeExchange: "stage4-real-badge-market-v3-clean-state",
  exchangeFeePct: require("./economicsPolicyV45").EXCHANGE_FEE_PCT,
  mainEvent: "retired-history-only",
  freerollRemainder: "carry-forward",
  myTicketsCleanup: "v41-runtime-owner-cache-boundary",
