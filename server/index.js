...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + contest-first leaderboard order v31 + modal unified leaderboard v30 + small baskets with stable list scroll v30 + compact stop family + DOM-safe chart polish v28 + normalized view landings v29; tutorials hard-paused`);
});
