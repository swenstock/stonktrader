...
app.get("/api/health", (req, res) => res.json({
  ...
  priceSync: "v2-authoritative-served",
  headerStocks: "v16",
...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + fixed-height portfolio top row/larger default chart/queued activity history + stabilized prize popout/basket controls/queue confirmation/performance + Stage 67 payout projections/chart popout/trade-size guard/My Contests cleanup + Stage 46 single-engine chart gesture lock v51 + Stage 45 stabilized/wide chart v50 + Stage 43 chart/order UI v48 + Stage 42 workspace v47; tutorials hard-paused`);
});
