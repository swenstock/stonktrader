...
app.get("/api/health", (req, res) => res.json({
  ...
  headerStocks: "v16",
  entryActions: "v20",
  entryTradeHandoff: "v23-requery",
  myContestPosition: "v23",
}));
...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket v19 + compact stop family + chart-header symbol selector v20 + entry actions v20 + entry trade/My Contests position v23; tutorials hard-paused`);
});
