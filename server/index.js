...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + any-count auto-rebalanced baskets v31 + ticket exchange controls v36 + popup-only leaderboard v34 + native tier card sizing + contest-first leaderboard order v31 + compact stop family + DOM-safe chart polish v28 + normalized view landings v29; tutorials hard-paused`);
});
