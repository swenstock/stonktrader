...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + Create A Basket v19 + compact stop family + chart-header symbol selector v20 + entry actions with native trade preserved + native My Contests positioning v27; tutorials hard-paused`);
});
