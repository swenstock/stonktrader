...
app.get("/api/health", (req, res) => res.json({
  ...
  ticketExchangeControls: "v35-my-orders-reprice-close",
}));
...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + ticket exchange controls v35 + popup-only leaderboard v34 + native tier card sizing + contest-first leaderboard order v31 + small baskets with stable list scroll v30 + compact stop family + DOM-safe chart polish v28 + normalized view landings v29; tutorials hard-paused`);
});
