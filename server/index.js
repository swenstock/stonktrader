...
app.get("/api/health", (req, res) => res.json({
  ...
  tradeCleanup: "v10",
  createABasket: "v29-native-portfolio-context",
...
server.listen(PORT, () => {
  ...
  console.log(`Visible shell: exact V45 + native-context basket v29 + compact stop family + DOM-safe chart polish v28 + native Trade This Entry + normalized view landings v29; tutorials hard-paused`);
});
