...
const race=runUi('public/v45-broker-race-ui.js').__SBC_BROKER_RACE_UI_TEST;assert.ok(race);assert.strictEqual(race.PROMOTION_COPY.heroHeadline,"CAN'T AFFORD ONE?");assert.ok(race.PROMOTION_COPY.heroSupport.includes('COLLECT 20. GET PROMOTED.'));
